class SccFinder(object):
    ...
    def _add_edge_to_graph(self, from_v, to_v):
        '''
        add a directed edge to adjacency list from `from_v` to `to_v`
        '''
    ...
    def compute_finish_times(self):
        '''
        First pass of the Kosaraju's algorithm
        '''
